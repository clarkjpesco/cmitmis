...
class AdminController
{
    ...
    //         $result = $this->studentService->importStudentsFromExcel($uploadedFile['tmp_name']);

    //         if ($result['success']) {
    //             $_SESSION['success'] = "Successfully imported {$result['imported']} students.";
    ...
    //         // Redirect to progress page which will start the import
    ...
    // {
    //     // This page shows the progress UI and starts the import
    //     echo $this->view->render('/admin/students_import_progress.php', [
    //         'active' => 'students'
    //     ]);

    //     // Start import in background (if not already started)
    //     if (isset($_SESSION['import_file']) && file_exists($_SESSION['import_file'])) {
    //         $filePath = $_SESSION['import_file'];

    //         // Use output buffering and flush to show progress
    //         ob_flush();
    //         flush();

    //         $result = $this->studentService->importStudentsFromExcelWithProgress($filePath);
    ...
    public function importProgressPage()
    {
        ...
        // Start the import (this will take time)

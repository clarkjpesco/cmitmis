        ...
        <div class="flex items-center justify-between p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">View and manage student grades</p>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Select a student to view and manage their grades</p>
                </div>
                            ...
                            <?php foreach ($students as $student): ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                ...
                                                <?php echo $student['graded_count'] ?? 0; ?> graded
                                            </span>
                                            <?php if (($student['pending_count'] ?? 0) > 0): ?>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                    <i class="fas fa-clock mr-1"></i>
                                                    <?php echo $student['pending_count']; ?> pending
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <?php if (isset($student['average_grade']) && $student['average_grade']): ?>
                                            <span class="text-lg font-semibold <?php echo $student['average_grade'] <= 3.0 ? 'text-green-600' : 'text-red-600'; ?>">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <a href="/admin/grades/student/<?php echo $student['id']; ?>/details"
                    ...
                    <div>
                        <nav
                            ...
                            <?php if ($currentPage > 1): ?>
                                <a
                                    href="/admin/grades?<?php echo e($previousPageQuery); ?>"
                            ...
                            <?php foreach ($pageLinks as $pageNum => $query): ?>
                                ...
                                <a
                                    href="/admin/grades?<?php echo e($query); ?>"
                            ...
                            <?php if ($currentPage < $lastPage): ?>
                                <a
                                    href="/admin/grades?<?php echo e($nextPageQuery); ?>"

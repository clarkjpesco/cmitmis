        ...
        <div class="flex items-center justify-between p-4">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Create and save a new course with its code, name, and description.</p>
                </div>
            </div>
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <input
                            ...
                            id="courseName"
                            name="courseName"
                            value="<?php echo e($oldFormData['courseName'] ?? ''); ?>"
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="courseCode"
                            name="courseCode"
                            value="<?php echo e($oldFormData['courseCode'] ?? ''); ?>"
                            required
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                            placeholder="Enter course name" />
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                            placeholder="Enter course description">  <?php echo e($oldFormData['courseDescription'] ?? ''); ?></textarea>
